...
# FIXME: can we get rid of `meta_data`?
...
2) If there are two identities, we return ambiguous
3) If there are > 2 identities, we find the mode

```{r}
# Returns the most common identifier amongst those given. If there is a tie or no identifier, returns "ambiguous"
