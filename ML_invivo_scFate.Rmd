...
if (settings.remove_unused) { rm(n_day2_cells) }
```
...
LT.seu.day2@meta.data <- LT.seu.day2@meta.data %>%mutate(final.ident = mutator)
LT.seu.day2 <- subset(LT.seu.day2, subset = final.ident != "NA")

if (settings.remove_unused) { rm(mutator) }
