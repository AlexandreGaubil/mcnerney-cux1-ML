...
wd <- "/Users/weihan/Desktop/Research/mcnerney-cux1-ML"

#knitr::opts_chunk$set(echo = FALSE)
#<<<<<<< solve_invivo_preprocessing
#setwd(wd)
...
if (!file.exists("./data/in_vivo/input_for_Seurat/matrix.mtx.gz")) {
  ...
  writeMM(count_mtx, "./data/in_vivo/input_for_Seurat/matrix.mtx")
...
clone_membership <- as.vector(clone_membership)
...
```{r}
saveRDS(LT.seu.day2, file = "./data/in_vivo/RDS_objects/LT_seu_day2_ML_source_data.rds")
```
