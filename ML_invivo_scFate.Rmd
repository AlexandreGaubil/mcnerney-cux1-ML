...
# Remove all cells whose identity is not Baso, Mono, or Neu
...
```{r}
saveRDS(LT.seu.day2, file = "./data/LT_seu_day2_ML_source_data_alternative-cell-classification.rds")
```
...
day2.count.neg.ctrl
# Export the df
write.table(day2.count.neg.ctrl,"./data/ML_classifier/input_data/rand_genes_neg_ctrl_alternative-cell-classification.txt")
