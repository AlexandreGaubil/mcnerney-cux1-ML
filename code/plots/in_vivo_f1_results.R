...
df <- add_row(df,
              ...
              n_boostraps = n.bootstraps.default,
              n_rdm_gene_samples = n.rdm_gene_samples.default.yes,
              average = 0.3264148105126523,
              std_deviation = 0.03663936233714103,
              t_test_neg_ctrl = NaN,
              t_test_pos_ctrl = NaN)
...
df <- add_row(df,
              ...
              n_boostraps = n.bootstraps.default,
              n_rdm_gene_samples = n.rdm_gene_samples.default.yes,
              average = 0.46792424873591165,
              std_deviation = 0.04271610840761488,
              t_test_neg_ctrl = NaN,
              t_test_pos_ctrl = NaN)
...
df <- add_row(df,
              ...
              n_boostraps = n.bootstraps.default,
              n_rdm_gene_samples = n.rdm_gene_samples.default.yes,
              average = 0.42444561419172666,
              std_deviation = 0.04152081159804358,
              t_test_neg_ctrl = NaN,
              t_test_pos_ctrl = NaN)
...
df <- add_row(df,
              ...
              n_boostraps = n.bootstraps.default,
              n_rdm_gene_samples = n.rdm_gene_samples.default.yes,
              average = 0.49346392351432555,
              std_deviation = 0.0442799717575704,
              t_test_neg_ctrl = NaN,
              t_test_pos_ctrl = NaN)