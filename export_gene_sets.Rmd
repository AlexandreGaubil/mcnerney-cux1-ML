...
LT.seu.day2 <- readRDS(file = "./data/cache/LT_seu_day2_ML_source_data.rds")

if (!dir.exists("./data/output/export_script/")) {
  warning("No `data/output/export_script` directory found, creating one now...")
  dir.create("./data/output/export_script")
}
```
...
write.table(day2.all_cells.all_genes.data,
            row.names = FALSE,
            col.names = FALSE,
            "./data/output/export_script/all_cells_all_genes_data.txt")
...
write.table(day2.all_cells.all_genes.feature,
            row.names = FALSE,
            col.names = TRUE,
            "./data/output/export_script/all_cells_all_genes_features_headers.txt")
```
...
write.table(day2.all_cells.2000_var.data,
            row.names = FALSE,
            col.names = FALSE,
            "./data/output/export_script/all_cells_2000_var_data.txt")
write.table(day2.all_cells.2000_var.feature,
            row.names = FALSE,
            col.names = FALSE,
            "./data/output/export_script/all_cells_2000_var_features.txt")

write.table(day2.all_cells.2000_var.data,
            row.names = FALSE,
            col.names = TRUE,
            "./data/output/export_script/all_cells_2000_var_data_headers.txt")
write.table(day2.all_cells.2000_var.feature,
            row.names = FALSE,
            col.names = TRUE,
            "./data/output/export_script/all_cells_2000_var_features_headers.txt")
```