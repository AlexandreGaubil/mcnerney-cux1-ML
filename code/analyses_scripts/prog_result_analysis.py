# WARNING: Before running this script to compile results, search the output
# file for the following regular expression:
...
f = open(os.path.join(__location__, 'prog_lr_3c_Ren_Ba_DEG.txt'), 'r')
