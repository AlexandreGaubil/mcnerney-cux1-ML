...
if (!file.exists("./data/cache/input_for_Seurat/matrix.mtx.gz")) {
  ...
  if (file.exists("./data/cache/input_for_Seurat/matrix.mtx")) {
...
t_clone_matrix <- readMM("./data/input/clone_matrix.mtx")
...
```{r}
LT.data <- Read10X(data.dir="./data/cache/input_for_Seurat", gene.column=1)
